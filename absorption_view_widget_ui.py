...
class Ui_AbsorptionViewWidget(object):
    def setupUi(self, AbsorptionViewWidget):
        ...
        self.OD_ImageView = ImageViewEditor(self.OD_tab)
        self.OD_ImageView.setObjectName("OD_ImageView")
        self.gridLayout_3.addWidget(self.OD_ImageView, 0, 0, 1, 1)
        ...
        self.atom_ImageView = ImageViewEditor(self.atom_tab)
        self.atom_ImageView.setObjectName("atom_ImageView")
        self.gridLayout_4.addWidget(self.atom_ImageView, 0, 0, 1, 1)
        ...
        self.bright_ImageView = ImageViewEditor(self.bright_tab)
        self.bright_ImageView.setObjectName("bright_ImageView")
        self.gridLayout_6.addWidget(self.bright_ImageView, 0, 0, 1, 1)
        ...
        self.dark_ImageView = ImageViewEditor(self.dark_tab)
        self.dark_ImageView.setObjectName("dark_ImageView")
        self.gridLayout_5.addWidget(self.dark_ImageView, 0, 0, 1, 1)
