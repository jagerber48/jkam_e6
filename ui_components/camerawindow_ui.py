...
class Ui_CameraWindow(object):
    def setupUi(self, CameraWindow):
        ...
        self.savebox_verticalLayout.addItem(spacerItem)
        self.gridLayout.addLayout(self.savebox_verticalLayout, 1, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.video_mode_radioButton, 3, 0, 1, 1)
        self.fluorescence_mode_radioButton = QtWidgets.QRadioButton(self.image_capture_mode_frame)
        ...
        self.gridLayout_5.addWidget(self.fluorescence_mode_radioButton, 2, 0, 1, 1)
        self.mode_analysis_gridLayout.addWidget(self.image_capture_mode_frame, 1, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.mode_analysis_gridLayout.addItem(spacerItem1, 2, 0, 1, 2)
        ...
        self.gridLayout.addLayout(self.mode_analysis_gridLayout, 1, 0, 1, 1)
