...
class Ui_CameraWindow(object):
    def setupUi(self, CameraWindow):
        ...
        self.gridLayout.addWidget(self.savebox_widget, 3, 3, 1, 1)
        ...
        self.verticalLayout_2.addWidget(self.image_capture_mode_frame)
        ...
        self.verticalLayout_2.addWidget(self.roi_analyzer_frame)
        ...
        self.gridLayout.addWidget(self.view_stackedWidget, 0, 0, 3, 5)
...
from saveboxwidget import SaveBoxWidget
