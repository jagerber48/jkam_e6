...
class Ui_CameraControlWidget(object):
    def setupUi(self, CameraControlWidget):
        ...
        CameraControlWidget.resize(203, 200)
        CameraControlWidget.setMinimumSize(QtCore.QSize(203, 200))
        CameraControlWidget.setMaximumSize(QtCore.QSize(203, 200))
        ...
        self.gridLayout.addWidget(self.exposure_pushButton, 5, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.absorption_radioButton, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.video_radioButton, 6, 1, 1, 1)
        ...
        self.gridLayout.addLayout(self.exposure_formLayout, 3, 0, 1, 2)
