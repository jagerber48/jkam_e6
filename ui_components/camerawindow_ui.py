...
class Ui_CameraWindow(object):
    def setupUi(self, CameraWindow):
        ...
        self.verticalLayout_2.addWidget(self.savebox_widget)
        ...
        self.gridLayout_7.addWidget(self.camera_control_widget, 0, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.image_capture_mode_frame, 1, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.roi_analyzer_frame, 1, 1, 1, 1)
