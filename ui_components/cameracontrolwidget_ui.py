...
class Ui_CameraControlWidget(object):
    def setupUi(self, CameraControlWidget):
        ...
        CameraControlWidget.resize(489, 206)
        ...
        self.gridLayout_2.addWidget(self.serial_label, 0, 0, 1, 1)
        self.start_pushButton = QtWidgets.QPushButton(self.frame)
        self.start_pushButton.setEnabled(False)
        self.start_pushButton.setObjectName("start_pushButton")
        self.gridLayout_2.addWidget(self.start_pushButton, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.continuous_radioButton, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.hardware_trigger_radioButton, 3, 1, 1, 1)
        self.trigger_mode_label = QtWidgets.QLabel(self.frame)
        self.trigger_mode_label.setObjectName("trigger_mode_label")
        self.gridLayout_2.addWidget(self.trigger_mode_label, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.exposure_pushButton, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.software_trigger_radioButton, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.software_trigger_pushButton, 4, 1, 1, 2)
        self.arm_pushButton = QtWidgets.QPushButton(self.frame)
        self.arm_pushButton.setObjectName("arm_pushButton")
        self.gridLayout_2.addWidget(self.arm_pushButton, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.triggered_radioButton, 1, 1, 1, 1)
        self.trigger_source_label = QtWidgets.QLabel(self.frame)
        self.trigger_source_label.setObjectName("trigger_source_label")
        self.gridLayout_2.addWidget(self.trigger_source_label, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.exposure_formLayout, 3, 0, 1, 1)
