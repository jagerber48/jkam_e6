...
class Ui_CameraControlWidget(object):
    def setupUi(self, CameraControlWidget):
        ...
        self.gridLayout.addWidget(self.video_radioButton, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.absorption_radioButton, 6, 1, 1, 1)
    ...
    def retranslateUi(self, CameraControlWidget):
        ...
        self.video_radioButton.setText(_translate("CameraControlWidget", "Absorption"))
        self.absorption_radioButton.setText(_translate("CameraControlWidget", "Video"))
